            ...
            <div class="card-body px-lg-5 pt-0">
                ...
                <?php echo form_open_multipart(base_url('dashboard/setting'),['class' => 'p-5']); ?>
                        <div class="form-group">
                            ...
                            <input type="text" id="username" class="form-control" name="username" value="{{ set_new_value('username',$users['username']) }}" placeholder="Username">
                            <small class="text-danger">{{ form_error('username') }}</small>
                        </div>
                        <div class="form-group">
                            <label for="email">Email</label>
                            <input type="text" id="email" class="form-control" name="email" value="{{ set_new_value('email',$users['email']) }}" placeholder="jhon@mail.com">
            ...
            <div class="card-body px-lg-5 pt-0">
                ...
                <?php echo form_open_multipart(base_url('dashboard/setting/sosmed'),['class' => 'p-5']); ?>
                        <div class="form-group">
                            ...
                            <input type="text" id="facebook" class="form-control" name="facebook" value="{{ set_new_value('facebook',$sosmed['facebook']) }}" placeholder="Facebook Link">
                        </div>
                        <div class="form-group">
                            <label for="youtube">youtube</label>
                            <input type="text" id="youtube" class="form-control" name="youtube" value="{{ set_new_value('youtube',$sosmed['youtube']) }}" placeholder="youtube Link">
                        </div>
                        <div class="form-group">
                            <label for="twitter">twitter</label>
                            <input type="text" id="twitter" class="form-control" name="twitter" value="{{ set_new_value('twitter',$sosmed['twitter']) }}" placeholder="Link twitter">
                        </div>
                        <button class="btn btn-info my-4" type="submit">Save</button>
                        <a href="{{ base_url('dashboard/listing/') }}" class="btn btn-primary my-4">Back</a>
                </form>
