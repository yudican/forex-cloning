...
<a href="<?php echo e(base_url('dashboard/listing/new')); ?>" class="btn btn-primary">new listing</a>
...
<script type="text/javascript">
   $(document).ready(function () {
       var table = $("#tabel_listing").dataTable({
           "bProcessing": false,
           "bServerSide": true,
           "sAjaxSource": "<?php echo e(site_url('dashboard/listing/show')); ?>",
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/forex-cloning/application/views/dashboard/index.blade.php ENDPATH**/ ?>