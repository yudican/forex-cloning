...
<div class="bg-white" >
    ...
    <div class="inline ml-auto">
        ...
        <a href="" class="btn social-media-navbar text-center"><i class="fab fa-facebook-f"></i></a>
        <a href="" class="btn social-media-navbar text-center"><i class="fab fa-youtube" style="margin-left:-2px;"></i></a>
        <a href="" class="btn social-media-navbar text-center"><i class="fab fa-twitter"></i></a>
    </div>
    </nav>
</div>
<!-- end navbar -->
...
</html><?php /**PATH /opt/lampp/htdocs/forex/application/views/layout/master.blade.php ENDPATH**/ ?>